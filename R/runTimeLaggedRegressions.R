...
makeMeansDF <- function(target,modelPath){
...
getModelNoCulturalHistoricControl <- function(dependent) {
    ...
    '
            ...
            exec<-sprintf(exec, pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp) 
        ...
        for (pp in dependent){
            ...
            #pp<-substr(pp, 1, 3)
            exec <-'+ beta%s * %s[i]'
            exec<-sprintf(exec, pp,pp,pp,pp,pp,pp,pp,pp) 
...
getModel <- function(dependent) {
    ...
    '
            ...
            exec<-sprintf(exec, pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp) 
        ...
        for (pp in dependent){
            ...
            #pp<-substr(pp, 1, 3)
            exec <-'+ beta%s * %s[i]'
            exec<-sprintf(exec, pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp,pp) 
...
getDataFile <- function(target,dependent,culture,adultAge,lag,modelPath,culturalHistoryControl) {

    Y<-makeMeansDF(target,modelPath)
...
saveDiagnostics <- function(pathDiag,stan) {
    ...
    #save trace plots from MCMC chains
...
RunStanModel <- function(culturalHistoryControl,targets,dependent,culture,warmup,iter,LAG,adultAge) {
    
    for (target in targets) {
        for (lag in LAG) { 
            
            modelPath <- paste('timeSeriesForRegression/',sep='')
        
            pathResults <- paste('results/',toString(lag),'/',substr(target, 1, 3),'/',sep='')
            pathDiag <- paste('diagnostics/',toString(lag),'/',substr(target, 1, 3),'/',sep='')
            pathSummary <- paste('summaryStats/',toString(lag),'/',substr(target, 1, 3),'/',sep='') 


            data<-getDataFile(target,dependent,culture,adultAge,lag,modelPath,culturalHistoryControl)
...
#modelName <- 'InstabilityInequalityLogGDP_CON'
...
RunStanModel(culturalHistoryControl,targets,dependent,culture,warmup,iter,LAG,adultAge)
